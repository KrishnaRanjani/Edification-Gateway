...
public class areahome extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_areahome);
        Button scigg;
        ...
        Button artbee;
        artbee= findViewById(R.id.artdj);
        artbee.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in4=new Intent(getApplicationContext(),artquallist.class);
                startActivity(in4);
            }
        });
        final Button social ;
        ...
        social.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in5 =new Intent(getApplicationContext(),social.class);
                startActivity(in5);
            }
        });
        final Button aesthetic ;
        aesthetic = (Button)findViewById(R.id.aesthetic);
        aesthetic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in6 =new Intent(getApplicationContext(),aesthetic.class);
                startActivity(in6);
            }
        });
